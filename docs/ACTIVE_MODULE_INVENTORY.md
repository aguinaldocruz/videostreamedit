# Active module reachability inventory
...
Dynamic imports, startup registration, compatibility imports, and runtime monkey-patching can make a module active even when static reachability misses it.
